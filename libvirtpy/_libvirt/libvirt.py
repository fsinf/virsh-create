...
class virDomain:
    ...
    def blockRebase(self, disk, base, bandwidth, flags):
    ...
    def pMSuspendForDuration(self, target, duration, flags):
    ...
    def blockIoTune(self, disk, flags):
    ...
    def blockPeek(self, disk, offset, size, flags):
    ...
    def interfaceParameters(self, device, flags):
    ...
    def memoryPeek(self, start, size, flags):
    ...
    def setInterfaceParameters(self, device, params, flags):
...
class virStorageVol:
    ...
    def resize(self, capacity, flags):
    ...
    def wipePattern(self, algorithm, flags):
